# Prompt - OpenSpec Fast Forward: flowboard-mvp-foundation

You are implementing OpenSpec change: flowboard-mvp-foundation in Fast Forward mode.
...
- You MUST implement exactly what is defined in:
  - openspec/changes/flowboard-mvp-foundation/
...
- Work one unchecked task at a time from openspec/changes/flowboard-mvp-foundation/tasks.md.
