# Prompt - OpenSpec Fast Forward: add-task-dnd-interaction

You are implementing OpenSpec change: add-task-dnd-interaction in Fast Forward mode.
...
- You MUST implement exactly what is defined in:
  - openspec/changes/add-task-dnd-interaction/
...
- Work one unchecked task at a time from openspec/changes/add-task-dnd-interaction/tasks.md.
- For each task:
