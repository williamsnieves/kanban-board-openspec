# Prompt - OpenSpec Fast Forward: quality-gates-definition-impl

You are implementing OpenSpec change: quality-gates-definition-impl in Fast Forward mode.
...
- You MUST implement exactly what is defined in:
  - openspec/changes/quality-gates-definition-impl/
...
- Work one unchecked task at a time from openspec/changes/quality-gates-definition-impl/tasks.md.
- For each task:
