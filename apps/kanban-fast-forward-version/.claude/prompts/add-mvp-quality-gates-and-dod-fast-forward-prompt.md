# Prompt - OpenSpec Fast Forward: add-mvp-quality-gates-and-dod

You are implementing OpenSpec change: add-mvp-quality-gates-and-dod in Fast Forward mode.
...
- You MUST implement exactly what is defined in:
  - openspec/changes/add-mvp-quality-gates-and-dod/
...
- Work one unchecked task at a time from openspec/changes/add-mvp-quality-gates-and-dod/tasks.md.
- For each task:
