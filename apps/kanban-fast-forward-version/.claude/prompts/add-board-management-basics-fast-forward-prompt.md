# Prompt - OpenSpec Fast Forward: add-board-management-basics

You are implementing OpenSpec change: add-board-management-basics in Fast Forward mode.
...
- You MUST implement exactly what is defined in:
  - openspec/changes/add-board-management-basics/
...
- Work one unchecked task at a time from openspec/changes/add-board-management-basics/tasks.md.
- For each task:
