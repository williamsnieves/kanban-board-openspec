# Prompt - OpenSpec Fast Forward: add-task-priority-and-due-date

You are implementing OpenSpec change: add-task-priority-and-due-date in Fast Forward mode.
...
- You MUST implement exactly what is defined in:
  - openspec/changes/add-task-priority-and-due-date/
...
- Work one unchecked task at a time from openspec/changes/add-task-priority-and-due-date/tasks.md.
- For each task:
