# Prompt - OpenSpec Fast Forward: add-app-foundation-react-ts-vite-vitest

You are implementing OpenSpec change: add-app-foundation-react-ts-vite-vitest in Fast Forward mode.
...
- You MUST implement exactly what is defined in:
  - openspec/changes/add-app-foundation-react-ts-vite-vitest/
...
- Work one unchecked task at a time from openspec/changes/add-app-foundation-react-ts-vite-vitest/tasks.md.
- For each task:
