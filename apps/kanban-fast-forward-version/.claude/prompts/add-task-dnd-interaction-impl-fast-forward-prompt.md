# Prompt - OpenSpec Fast Forward: add-task-dnd-interaction-impl

You are implementing OpenSpec change: add-task-dnd-interaction-impl in Fast Forward mode.
...
- You MUST implement exactly what is defined in:
  - openspec/changes/add-task-dnd-interaction-impl/
