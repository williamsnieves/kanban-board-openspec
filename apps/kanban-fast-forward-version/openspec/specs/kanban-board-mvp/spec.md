...
Core MVP capabilities for the Kanban board application: board management, default columns, task lifecycle, task ordering and movement, local-first persistence, and deterministic validation feedback.
