...
Defines the drag-and-drop interaction model for task cards on the Kanban board, including draggable behavior, deterministic drop and reorder rules, visual feedback for valid and invalid targets, and a keyboard-accessible fallback for users who cannot use drag-and-drop.
