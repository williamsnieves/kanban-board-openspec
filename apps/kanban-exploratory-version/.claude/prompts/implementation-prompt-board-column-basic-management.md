...
Use this template to generate a prompt for any `board-column-basic-management` without hardcoding spec names.

---

You are implementing OpenSpec change: `board-column-basic-management` in Fast Forward mode.
...
- Change path: `openspec/changes/board-column-basic-management/`
- Follow `AGENTS.md` once created and project conventions.

Execution protocol (strict):

- Work one unchecked task at a time from `openspec/changes/board-column-basic-management/tasks.md`.
...
- Validation log: commands + results (including `openspec validate board-column-basic-management` and test runs)
