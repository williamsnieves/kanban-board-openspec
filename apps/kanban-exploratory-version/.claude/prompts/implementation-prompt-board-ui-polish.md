...
Use this template to generate a prompt for any ` board-ui-polis` without hardcoding spec names.

---

You are implementing OpenSpec change: ` board-ui-polis` in Fast Forward mode.
...
- Change path: `openspec/changes/ board-ui-polis/`
- Follow `AGENTS.md` once created and project conventions.

Execution protocol (strict):

- Work one unchecked task at a time from `openspec/changes/ board-ui-polis/tasks.md`.
...
- Validation log: commands + results (including `openspec validate  board-ui-polis` and test runs)
