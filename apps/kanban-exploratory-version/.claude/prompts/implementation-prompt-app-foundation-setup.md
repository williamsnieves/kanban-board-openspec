...
Use this template to generate a prompt for any `app-foundation-setup` without hardcoding spec names.

---

You are implementing OpenSpec change: `app-foundation-setup` in Fast Forward mode.
...
- Change path: `openspec/changes/app-foundation-setup/`
- Follow `AGENTS.md` once created and project conventions.

Execution protocol (strict):

- Work one unchecked task at a time from `openspec/changes/app-foundation-setup/tasks.md`.
...
- Validation log: commands + results (including `openspec validate app-foundation-setup` and test runs)
